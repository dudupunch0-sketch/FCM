...
- **콘텐츠 목표는 개수가 아니라 균형 흡수량이다.** "몇 개를 만들었나"가 아니라 "만든 것 중 몇 개가 최적 플레이에 등장하나"로 잰다. 개수 목표는 죽은 카드를 쌓아도 달성된다. 현재 균형 미등장 카드 3종(`hook`, `lowguard`, `flicker`)이 실질 문제이며, 새 카드를 만들기 전에 정리한다.
